...
export const AnimatedTestimonials = ({
  ...
  // Deterministic small rotation so SSR/CSR match
  const rotationForIndex = (i: number) => {
    return ((i * 7) % 21) - 10; // -10..10
  };
      ...
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
              ...
              {testimonials.map((testimonial, index) => (
                <motion.div
                  ...
                  animate={{
                    ...
                    rotate: isActive(index) ? 0 : rotationForIndex(index),
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="group/button flex h-7 w-7 items-center justify-center rounded-full border border-white text-white bg-transparent"
            >
