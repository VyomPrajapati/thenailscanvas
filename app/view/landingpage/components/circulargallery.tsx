...
function autoBind(instance: Record<string, unknown>): void {
  ...
  Object.getOwnPropertyNames(proto).forEach(key => {
    if (key !== 'constructor' && typeof instance[key] === 'function') {
      (instance[key] as (...args: unknown[]) => unknown).bind(instance);
    }
  });
}
    ...
    this.program = new Program(this.gl, {
      ...
      vertex: `
        ...
        void main() {
          vUv = uv;
          vec3 p = position;
          // Remove the watery wave effect by setting z to 0
          p.z = 0.0;
...
class App {
  ...
  update() {
    ...
    // Auto circulate when not interacting
    if (this.autoPlay && !this.isDown && !this.isHovering) {
...
export default function CircularGallery({
  ...
  }, [items, bend, textColor, borderRadius, font, scrollSpeed, scrollEase, autoPlay, autoSpeed]);
