...
export const LayoutGrid = ({ cards }: { cards: Card[] }) => {
  ...
  // Re-enable click enlarge but without page-darkening backdrop
  ...
  return (
    <div className="w-full p-4 md:p-6 lg:p-8 grid grid-cols-1 md:grid-cols-3 max-w-7xl mx-auto gap-4 md:gap-3 lg:gap-4 relative will-change-transform">
      ...
      {/* transparent overlay to capture outside clicks without dimming */}
      <motion.div
